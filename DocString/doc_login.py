...
class LoginWindow(QWidget):
    def __init__(self, parent=None):
        """
        Initializes login window and sets up UI components.
        """
    ...
    def init_ui(self):
        """
        Sets up UI, input fields, and buttons for login and registration.
        """
        layout = QVBoxLayout()
    ...
    def handle_login(self):
        """
        Handles the login attempt, validates credentials, and opens Dashboard window.
        """
    ...
    def open_register(self):
        """
        Opens registration window for creating new account.
        """
