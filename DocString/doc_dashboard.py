...
class DashboardWindow(QWidget):
    def __init__(self, username, parent=None):
        """
        Initializes the Dashboard window with the username and other UI components.
        """
    ...
    def init_ui(self):
        """
        Initializes the UI components and sets up buttons for different actions.
        """
        layout = QVBoxLayout()
    ...
    def format_reservation_text(self, reservation):
        """
        Formats the reservation text to display details of the current reservation.

        Args:
            reservation (dict): The reservation details to display.

        Returns:
            str: Formatted reservation details or "No active reservation."
        """
        if reservation:
            return (
    ...
    def refresh_dashboard(self):
        """
        Refreshes the dashboard with updated reservation data.
        """
        self.current_reservation = get_user_reservation(self.username)
        res_text = self.format_reservation_text(self.current_reservation)
    ...
    def reserve_spot(self):
        """
        Opens the ReserveMapWindow for reserving a parking spot.
        """
    ...
    def cancel_reservation(self):
        """
        Cancels the current reservation if there's an active reservation.
        """
